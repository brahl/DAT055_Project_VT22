...
public class Quotes implements Observable<Quotes> {


    private String res;
    private final Collection<Observer<Quotes>> observers;
    ...
    @Override
    public void addObserver(Observer<Quotes> o) {
        this.observers.add(o);
    }

    @Override
    public void removeObserver(Observer<Quotes> o) {
